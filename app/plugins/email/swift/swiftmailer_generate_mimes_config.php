...
function generateUpToDateMimeArray()
{
    ...
    foreach ($xml as $node) {
        ...
        foreach ((array) $node->glob["pattern"] as $extension) {
            ...
            $extension = explode('.', strtolower((string) $extension));
        ...
        if (isset($node->glob["pattern"][0])) {
            ...
            // get first extension
            $extension = strtolower(trim((string) $node->glob["ddpattern"][0], '*.'));
