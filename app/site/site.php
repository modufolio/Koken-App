<?php
    ...
    if ($url === '/') {
        ...
        } elseif (Koken::$site['default_front_page']) {
        ...
        foreach ($routes as $route => $page) {
            ...
            if (!empty($variables[0])) {
                foreach ($variables[1] as $str) {
                    ...
                    if ($str === ':year') {
                        $pattern = '[0-9]{4}';
                    } elseif ($str === ':month' || $str === ':day') {
                        $pattern = '[0-9]{1,2}';
                    } elseif ($str === ':id' || $str === ':content_id' || $str === ':album_id') {
