...
class DMZ_Nestedsets
{
     ...
     * @access	public
     */
    public function select_root($object, $tree = null)
    {
     ...
     * @access	public
     */
    public function new_root($object)
    {
     ...
     * @access	public
     */
    public function new_first_child($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
     ...
     * @access	public
     */
    public function new_last_child($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function new_previous_sibling($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function new_next_sibling($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function get_root($object)
    {
        // add a root index if needed
        if (in_array($this->_rootfield, $object->fields) && ! is_null($this->_rootindex)) {
     ...
     * @access	public
     */
    public function get_parent($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function get_node_where_left($object, $left_id)
    {
        // add a root index if needed
        if (in_array($this->_rootfield, $object->fields) && ! is_null($this->_rootindex)) {
            $object->db->where($this->_rootfield, $this->_rootindex);
     ...
     * @access	public
     */
    public function get_node_where_right($object, $right_id)
    {
        // add a root index if needed
        if (in_array($this->_rootfield, $object->fields) && ! is_null($this->_rootindex)) {
            $object->db->where($this->_rootfield, $this->_rootindex);
     ...
     * @access	public
     */
    public function get_first_child($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function get_last_child($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function get_previous_sibling($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function get_next_sibling($object, $node = null)
    {
        // a node passed?
        if (is_null($node)) {
            // no, use the object itself
     ...
     * @access	public
     */
    public function is_valid_node($object)
    {
        if (! $object->exists()) {
            return false;
     ...
     * @access	public
     */
    public function is_root($object)
    {
     ...
     * @access	public
     */
    public function is_leaf($object)
    {
     ...
     * @access	public
     */
    public function is_child($object)
    {
        return ($object->exists() && $this->is_valid_node($object) && $object->{$this->_leftindex} > 1);
    }
     ...
     * @access	public
     */
    public function is_child_of($object, $node = null)
    {
     ...
     * @access	public
     */
    public function is_parent_of($object, $node = null)
    {
        // validate the objects
        if (! $this->is_valid_node($object) or ! $this->is_valid_node($node)) {
            return false;
     ...
     * @access	public
     */
    public function has_parent($object)
    {
     ...
     * @access	public
     */
    public function has_children($object)
    {
     ...
     * @access	public
     */
    public function has_previous_sibling($object)
    {
     ...
     * @access	public
     */
    public function has_next_sibling($object)
    {
        // fetch the result using a clone
        $node = $object->get_clone();
     ...
     * @access	public
     */
    public function count_children($object)
    {
     ...
     * @access	public
     */
    public function make_next_sibling_of($object, $node)
    {
     ...
     * @access	public
     */
    public function make_previous_sibling_of($object, $node)
    {
        if (! $this->is_root($node)) {
     ...
     * @access	public
     */
    public function make_first_child_of($object, $node)
    {
     ...
     * @access	public
     */
    public function make_last_child_of($object, $node)
    {
     ...
     * @access	public
     */
    public function remove_tree($object, $tree_id = null)
    {
     ...
     * @access	public
     */
    public function remove_node($object)
    {
