...
class JPEG_ICC
{
     ...
     */
    public const ICC_HEADER_LEN = 14;

    /**
     * maximum data len of a JPEG marker
     */
    public const MAX_BYTES_IN_MARKER = 65533;

    /**
     * ICC header marker
     */
    public const ICC_MARKER = "ICC_PROFILE\x00";

    /**
     * Rendering intent field (Bytes 64 to 67 in ICC profile data)
     */
    public const ICC_RI_PERCEPTUAL = 0x00000000;
    public const ICC_RI_RELATIVE_COLORIMETRIC = 0x00000001;
    public const ICC_RI_SATURATION = 0x00000002;
    public const ICC_RI_ABSOLUTE_COLORIMETRIC = 0x00000003;
    ...
    public function SaveToBlob($blob)
    {
        if ($this->icc_profile == '') {
            return $blob;
        }
        $this->insertProfile($blob);
        return $blob;
    }
